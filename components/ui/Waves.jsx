...
const Waves = memo(({
  ...
  console.log('Waves component rendered');
  ...
  useEffect(() => {
    console.log('Waves config updated');
  ...
  useEffect(() => {
    console.log('Waves canvas setup');
    ...
    function setSize() {
      ...
      // Only set lines if we have valid dimensions
      if (boundingRef.current.width > 0 && boundingRef.current.height > 0) {
        setLines();
    ...
    // Create a ResizeObserver to handle initial size and resizes
